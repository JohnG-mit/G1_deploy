...
angle_register = {
    "fingerone": (1486, 2, 'short'),            # 小拇指寄存器地址
    "fingertwo": (1488, 2, 'short'),            # 无名指寄存器地址
    "fingerthree": (1490, 2, 'short'),          # 中指寄存器地址
    "fingerfour": (1492, 2, 'short'),           # 食指寄存器地址
    "fingerfive": (1494, 2, 'short'),           # 大拇指弯曲寄存器地址
    "fingerfive_rotate": (1496, 2, 'short')     # 大拇指旋转寄存器地址
}
...
# handler.client.write_register(angle_register["fingerfive_rotate"][0], 1000, handler.device_id)
